...
Snakes = function() {
  ...
  var cfg = {
    ...
    highscores: [
	  { name: "Red X",        score:  9500 },
      { name: "Babs",        score:  9200 }, 
      { name: "Circus Boy",       score:  8700 },
      { name: "ToddLives",    score:  7000 },
      { name: "Emit Relevart",      score:  6575 },
      { name: "TheCoolerClone",       score:  2440 },
      { name: "WonderofWonders", score:   1780 },
      { name: "Ahiru",     score:   895 },
      { name: "Leilo",    score:   100 }
    ],
